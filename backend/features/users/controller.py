...
def update_user(
    user_update: UserUpdate, current_user: User, session: Session = Depends(get_session)
) -> UserRead:
    """
...
def delete_user(delete_in: UserDelete, current_user: User, session: Session = Depends(get_session)):
    """
